    ...
    <label htmlFor={checkboxId} className={`inline-flex items-center gap-3 cursor-pointer ${className}`}>
      <div className="relative flex items-center justify-center">
        <input
          ...
          {...props}
        />
        <div className="w-5 h-5 rounded-[var(--radius-sm)] border-2 border-[var(--gray-300)] peer-checked:border-[var(--scale-primary-950)] peer-checked:bg-[var(--scale-primary-950)] transition-colors duration-[var(--duration-fast)]" />
