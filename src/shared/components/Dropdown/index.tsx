      ...
      {open && (
        <div
          className={`
            ...
            shadow-[var(--shadow-lg)] border border-[var(--color-border-light)] py-2 z-[var(--z-dropdown)]
            animate-fade-in
            ...
            <div key={idx}>
              ...
              <button
                ...
                className={`
                  ...
                  ${item.danger ? 'text-[var(--color-danger)] hover:bg-[var(--color-danger-bg)]' : 'text-[var(--gray-700)] hover:bg-[var(--color-bg-subtle,var(--gray-50))]'}
                `}
              >
